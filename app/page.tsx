...
export default function Home() {
  return <main>
    <nav className="nav"><div className="brand"><span>HAJA</span><small>ESCOLA DE INCORPORADORES</small></div><a href="#aula">A aula</a><a href="#metodo">Método 5/20</a><CTA>GARANTIR ACESSO · R$ 27</CTA></nav>

    <section className="hero" id="aula"><div className="hero-grid" /><div className="eyebrow">AULA ONLINE AO VIVO <i /> QUINTA-FEIRA, 13 DE AGOSTO</div><h1>O PROBLEMA<br /><em>DA OBRA ÚNICA</em></h1><p className="hero-lead">Você sabe construir.<br /><strong>Mas talvez ainda não tenha construído o modelo que permite crescer.</strong></p><p className="hero-copy">Descubra por que tantos construtores competentes continuam presos a uma obra por vez, ao próprio capital e a uma operação que depende deles para tudo — e conheça o método que José Carlos desenvolveu para transformar construção em um verdadeiro negócio de incorporação.</p><div className="hero-bottom"><div><span className="price-label">ACESSO À AULA</span><span className="price">R$ 27</span></div><CTA /><div className="byline">COM JOSÉ CARLOS CARDOSO<br /><span>Criador do Método 5/20 · CEO do Grupo Haja · +10 anos de mercado</span></div></div></section>
    ...
    <footer><div className="brand"><span>HAJA</span><small>ESCOLA DE INCORPORADORES</small></div><p>© 2026 Grupo Haja. Todos os direitos reservados.</p></footer>
  </main>;
}
